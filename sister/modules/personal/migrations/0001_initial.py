    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('photo', models.ImageField(upload_to='profiles', verbose_name='photo')),
                ('primary', models.BooleanField(default=False, editable=False)),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_set', to='sister_personal.person')),
            ],
            options={
                'verbose_name': 'Photo Profile',
                'verbose_name_plural': 'Photo Profile',
            },
        ),
        migrations.CreateModel(
            name='PersonContact',
