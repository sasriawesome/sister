...
class BaseWebView(WebViewMixin, TemplateResponseMixin, View):
    ...
    template_name = 'webapp/layout.html'
...
class CreateView(ModelFormMixin, ProcessFormView):
    ...
    template_name = 'webapp/pages/shared/change_form.html'
...
class DeleteView(WebSingleObjectMixin, BaseWebView):
    ...
    template_name = 'webapp/pages/shared/delete_form.html'
...
class PDFViewMixin:
    ...
    template_name = 'webapp/print/content.html'
    cover_template = 'webapp/print/cover.html'
    header_template = 'webapp/print/header.html'
    footer_template = 'webapp/print/footer_with_page_number.html'
