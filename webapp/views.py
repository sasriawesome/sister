...
class ProfileView(WebView):
    url_path = 'profile/'
    url_name = 'profile'
    template_name = 'webapp/pages/profil.html'

    def get_backurl(self):
        return reverse('webapp_index')
...
class KelasView(DetailView):
    ...
    url_name = 'kelas'
    template_name = 'webapp/pages/kelas.html'
    ...
    def get_menu_list(self):
        return [
            {
                'url': reverse(
                    'webapp_kelas_siswa_list', args=(self.object.id,)),
                'icon': 'user-graduate',
                'title': 'Siswa Kelas',
                'description': 'Daftar dan profil Siswa Kelas.'
            }, {
                'url': reverse(
                    'webapp_kelas_mapel_list', args=(self.object.id,)),
                'icon': 'book',
                'title': 'Mata Pelajaran',
                'description': 'Daftar Mata Pelajaran Kelas.'
            }, {
                'url': reverse(
                    'webapp_kelas_jadwal_list', args=(self.object.id,)),
                'icon': 'calendar-alt',
                'title': 'Jadwal Pelajaran',
                'description': 'Daftar jadwal Mata Pelajaran dalam seminggu.'
            }, {
                'url': reverse(
                    'webapp_kelas_piket_list', args=(self.object.id,)),
                'icon': 'calendar',
                'title': 'Piket Kelas',
                'description': 'Daftar Piket siswa dalam seminggu.'
            }, {
                'url': reverse(
                    'webapp_kelas_absensi_list', args=(self.object.id,)),
                'icon': 'hand-sparkles',
                'title': 'Absensi Kelas',
                'description': 'Daftar absensi siswa harian.'
            }, {
                'url': reverse(
                    'webapp_kelas_rentang_list', args=(self.object.id,)),
                'icon': 'bookmark',
...
class MapelKelasList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_mapel_list.html'

    def get_backurl(self):
        return reverse('webapp_kelas', args=(self.object.id,))
...
class MapelKelasDetail(DetailView):
    ...
    template_name = 'webapp/pages/kelas_mapel_detail.html'
...
class MapelKelasPenilaian(WebView):
    ...
    template_name = 'webapp/pages/kelas_mapel_penilaian.html'

    def get_backurl(self):
        origin = self.request.GET.get('origin', 'kelas')
        if origin == 'siswa':
            return reverse('webapp_siswakelas', args=(self.siswa.id,))
        else:
            url = reverse('webapp_mapelkelas', args=(self.mapel.id,))
            ori = "?origin=%s" % origin
...
class SiswaKelasList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_siswa_list.html'
...
class SiswaKelasDetail(DetailView):
    ...
    template_name = 'webapp/pages/kelas_siswa_detail.html'

    def get_backurl(self):
        return reverse(
            'webapp_kelas_siswa_list',
            args=(self.object.kelas.id,)
        )
...
class JadwalPelajaranList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_jadwal.html'
...
class JadwalPiketList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_piket.html'
...
class AbsensiList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_absensi.html'
...
class RentangNilaiList(DetailView):
    ...
    template_name = 'webapp/pages/kelas_rentang.html'
