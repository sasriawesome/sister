...
# from sister.api.views import GrapheneView
# from sister.api.tenant.v1 import schema
...
class KelasView(DetailView):
    ...
    url_name = 'kelas'
    template_name = 'sister_web/pages/kelas_detail.html'

    def get_backurl(self):
        return reverse('sister_web_kelas_list')
